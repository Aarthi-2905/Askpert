...
describe('DashHeader Component', () => {
    ...
    beforeAll(() => {
        import.meta.env.VITE_HOST = 'http://localhost';
    ...
    test('fetches user data on mount', async () => {
        ...
        await waitFor(() => {
          expect(global.fetch).toHaveBeenCalledWith(
            `${import.meta.env.VITE_HOST}:${import.meta.env.VITE_PORT}/verify/`,
            expect.any(Object)
          );
        });
    });
    ...
    test('fetches notifications on mount', async () => {
        ...
        await waitFor(() => {
            expect(global.fetch).toHaveBeenCalledWith(
                `${import.meta.env.VITE_HOST}:${import.meta.env.VITE_PORT}/notifications/`,
                expect.any(Object)
            );
        });
    });
